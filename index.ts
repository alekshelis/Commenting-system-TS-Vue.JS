class _Comment{
    ...
    constructor(name: string, text: string, photo?: string, date?: any, SecondComment?: boolean, favorites?: boolean, rating?: number, answer?: Array<object>, writeText?: string){
        this.name = name;
        this.text = text;
    ...
    addSecondComment(name, text, photo, date, SecondComment, favorites, rating){
        let secCom = new _Comment(name, text, photo, date, true, favorites, rating)
        this.answer.push(secCom)
    }
}

class _Page{
    allComments: Array<object>;
    // name: string;
    // text:string;
    ...
    addComment(name: string, text: string, photo?: string, date?: any, SecondComment?: boolean, favorites?: boolean, rating?: number, answers?: any){
        let com = new _Comment(name, text, photo, date, SecondComment, favorites, rating)
